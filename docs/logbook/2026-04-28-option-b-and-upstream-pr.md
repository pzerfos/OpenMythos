...
4. **FSDP1 → FSDP2 migration** (pzerfos/OpenMythos#6) — lower memory, `torch.compile` support. Worth doing before a larger-scale run. **Next step:** feasibility benchmark before committing to the migration; plan and scope in `docs/logbook/2026-04-29-fsdp2-feasibility-benchmark-plan.md`.
